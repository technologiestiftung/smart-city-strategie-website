import { isStaticPage } from "@utils/is-static-page";
    ...
    >
      ...
      >
        <svg
          ...
          width='24'
          height='24'
          className='col-span-2 p-1 bg-white rounded transform -translate-x-1'
        >
        ...
        <span className='col-span-10'>
          Diese externe Seite wird über der Dienst Notion verfügbar gemacht
        </span>
      </span>
    </a>
  );
